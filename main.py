        ...
        fields = {
            ...
            2: {
                ...
                27: {                    # Field 27 (critical for badge!)
                    1: 11,               # Field 27.1
                    2: 17815341588,      # Field 27.2 (your bot UID)
                    3: 9999              # Field 27.3
                },
                28: {},                   # Empty field 28
...
📝 Example: /spamroom 123456 17815341588 Hello World!
...
async def auto_reply_with_emote(emote_info, key, iv):
    ...
    try:
        ...
        bot_uid = 17815341588  # Replace with your bot's actual UID
...
# ========== লেন্থ 0 হলে ডুয়েল ইমোট পাঠান ==========
                        if len(response.Data.msg) == 0:
                            ...
                            bot_uid = 17815341588  # আপনার বটের UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "17815341588":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {xMsGFixinG(uid)}"
                                    count += 1
                                    if count >= 20:
...
📝 Examples:
/kkick {xMsGFixinG('17815341588')} - Kick single player with "Connection Lost"
/kkick {xMsGFixinG('17815341588')} {xMsGFixinG('123456789')} - Kick multiple players
